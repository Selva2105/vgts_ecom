    ...
    return (
        <div className='mx-10 mt-4'>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <div className="lg:w-2/4 xl:w-[60%] flex flex-col gap-4 mt-4 ">
                    {cart.map((item) => (
                        <div className="bg-gray-50 flex flex-col md:flex-row items-center justify-start md:justify-between gap-4 p-4 border border-gray-200 rounded-md" key={item.product.id}>
                            <div className="flex flex-col md:flex-row items-center gap-4">
                                <img src={getFirstImageUrl(item.product.images)} alt={item.product.title} className='w-full h-full md:w-20 md:h-20' />
                ...
                <div className="lg:w-2/4 xl:w-[40%] flex flex-col gap-4 mt-4 ">
